 ...
 */
#ifndef SPIF_BLOCK_DEVICE_H_FILE
#define SPIF_BLOCK_DEVICE_H_FILE
...
public:
     ...
     *
     * @param sport     SPI port (0 or 1), unused, it is defined above!
     ...
     */
    SPIFBlockDevice(uint8_t sport, PinName mosi, PinName miso, PinName sclk, PinName csel, int freq = 40000000);
...
private:
    ...
    uint8_t m_spi_pin_mosi;
    uint8_t m_spi_pin_miso;
    uint8_t m_spi_pin_sclk;
...
#endif  // SPIF_BLOCK_DEVICE_H_FILE
